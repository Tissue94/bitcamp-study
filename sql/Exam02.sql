...
insert into test1 values(null,'aaa','111','222','10101','seoul'); /* auto auto_increment 떄문에 null이어도 에러가 뜨지 않는다. */
...
- 값을 입력할 컬럼을 선택하기. 단 필수 입력 컬럼은 반드시 선택해야 한다./* not null 은 입력해야 한다*/
